...
export function GameFinished() {
  ...
  return (
    <section className="flex flex-col items-center gap-6 text-center animate-bounce-in w-full max-w-lg">
      <header className="flex flex-col gap-2">
        <h2 className="font-fun text-3xl md:text-4xl text-gray-400">
          Game Over!
        </h2>
      ...
      <div className="flex justify-center gap-8 font-fun text-3xl">
        <span
          className={clsx(
      ...
      <section className="flex flex-col gap-3 w-full bg-gray-50 rounded-2xl p-6 border-3 border-gray-100 shadow-sm">
