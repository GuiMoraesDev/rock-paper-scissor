...
E2E tests live in `e2e/` and use Playwright with Chromium. The Playwright config (`playwright.config.ts` at the repo root) automatically starts the Next.js dev server (port 3000) before running tests.
